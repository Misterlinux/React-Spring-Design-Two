  ...
  return(
    <div ref={primo}>
      ...
      <div className="d-flex justify-content-between">
        <div className="row mx-0 position-relative bg-primary d-flex align-items-center justify-content-center totalwindow">

          <div className="col-6 d-flex flex-column justify-content-center align-items-start text-white position-absolute present">
